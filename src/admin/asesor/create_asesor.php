              ...
              <div style="color: red;">
                ...
                if(isset($_POST['submit'])) {
                  if(isset($_FILES['assessor_photo'])){
                    ...
                    $sql = "INSERT INTO assessor SET assessor_name='$assessor_name', birth_place='$birth_place', birth_date='$birth_date', assessor_photo='$assessor_photo',
                    nik_number='$nik_number', gender='$gender', nationality='$nationality', address='$address', email='$email', 
                    phone_number='$phone_number', education_level='$education_level', bnsp_reg_num='$bnsp_reg_num', 
                    exp_date_sertificate='$exp_date_sertificate', institutional_name='$institutional_name', id_schema='$id_schema'";
